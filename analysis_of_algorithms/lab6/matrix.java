...
public class matrix {
	public static void main(String[] args) {
		...
		System.out.println("16 length array  strassen multiplication: " + elapsed_time + " nanosecs");
		...
		end_time = System.nanoTime();
		elapsed_time = end_time - start_time;
		System.out.println("64 length array strassen multiplication: " + elapsed_time + " nanosecs");

		// compute the elapsed time

		// part 1(e)
		// elapsed time for normal matrix multiplication with 16*16 array
		start_time = System.nanoTime();
		square_matrix_multiply(A_2, B_2, C_2);
		end_time = System.nanoTime();
		elapsed_time = end_time - start_time;
		System.out.println("16 length array multiplication with square matrix multiply:"
				+ +elapsed_time + " nanoseconds");

		// part 1(f)
		// elapsed time for normal matrix multiplication with 64*64 array
		start_time = System.nanoTime();
		square_matrix_multiply(A_3, B_3, C_3);
		end_time = System.nanoTime();
		elapsed_time = end_time - start_time;
		System.out.println("64 length array multiplication with square matrix multiply:"
				+ +elapsed_time + " nanoseconds");
